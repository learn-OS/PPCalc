...
public class DayPointsProviderMetadata {
    ...
    public static final class DayPointsTableMetadata implements BaseColumns {
        ...
        public static final Uri WEEK_URI =
                Uri.parse("content://" + AUTHORITY + "/week");
        public static final Uri MONTH_URI =
                Uri.parse("content://" + AUTHORITY + "/month");
        ...
        public static final String CONTENT_WEEK_TYPE = "vnd.android.cursor.dir/vnd.ppcalc.week_day";
